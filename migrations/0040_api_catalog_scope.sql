...
-- Widen the immutable credential grant allowlist without editing the applied
-- 0038 table. Existing rows are copied byte-for-byte and all lifecycle guards
-- are recreated on the renamed table.
CREATE TABLE api_credentials_v0040 (
...
INSERT INTO api_credentials_v0040 (
...
ALTER TABLE api_credentials_v0040 RENAME TO api_credentials;
