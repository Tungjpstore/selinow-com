...
-- SQLite rewrites trigger references when a table is renamed. Migration 0070
-- rebuilt shop_subscriptions, so restore the Mini App scope guard against the
-- canonical table instead of the dropped legacy table.
DROP TRIGGER IF EXISTS telegram_mini_app_sessions_scope_insert_guard;
