...
export type AppBindings = Omit<Env, "APP_ENV" | "CLOUDFLARE_ZONE_ID" | "INTEGRATION_QUEUE" | "MEDIA" | "NOTIFICATION_QUEUE" | "PLATFORM_CACHE" | "PLATFORM_DB" | "PRIVATE_EXPORTS" | "SAAS_CNAME_TARGET" | "SESSION" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_SITE_KEY"> & {
