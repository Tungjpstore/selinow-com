...
const ERROR_KEYS: Readonly<Record<string, string>> = {
  ...
  provider_not_ready: "integration.error.provider_not_ready",
  ...
  subscription_grace_expired: "integration.error.subscription_grace_expired",
  subscription_payment_required: "integration.error.subscription_payment_required",
