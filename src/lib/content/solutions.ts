...
const solutions: Readonly<Record<SolutionSlug, Readonly<Record<SupportedLocale, LocalizedSolution>>>> = {
  "telegram-commerce": {
    en: {
      ...
      faq: [
        { question: "Is Selinow only for Telegram?", answer: "No. Telegram is the first channel, while Website and later channels use the same commerce core." },
    ...
    "vi-VN": {
      ...
      faq: [
        { question: "Selinow chỉ dành cho Telegram?", answer: "Không. Telegram là kênh đầu tiên; Website và các kênh mở rộng sau đó dùng chung commerce core." },
...
const hub: Readonly<Record<SupportedLocale, SolutionsHubContent>> = {
  en: {
    ...
    title: "The operating layer behind a global digital store.",
    lead: "Start with the workflow that matters most today, then connect the next one without splitting your catalog, payment evidence, or fulfillment history.",
    answerLabel: "Where to start",
    answer: "Selinow gives digital sellers one bilingual commerce core for channel conversations, verified checkout, and controlled delivery.",
    ...
    ctaSecondary: "Compare plans",
    footerTagline: "Global commerce operations for digital products.",
  },
  "vi-VN": {
    ...
    title: "Lớp điều hành phía sau một cửa hàng sản phẩm số toàn cầu.",
    lead: "Bắt đầu từ luồng quan trọng nhất hôm nay, rồi kết nối luồng tiếp theo mà không tách catalog, bằng chứng thanh toán hay lịch sử fulfillment.",
    answerLabel: "Nên bắt đầu từ đâu",
    answer: "Selinow cung cấp commerce core song ngữ cho cuộc trò chuyện trên các kênh, checkout được xác minh và giao hàng có kiểm soát.",
    ...
    ctaSecondary: "So sánh bảng giá",
    footerTagline: "Vận hành thương mại toàn cầu cho sản phẩm số.",
  },
};
