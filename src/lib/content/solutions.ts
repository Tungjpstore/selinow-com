...
const solutions: Readonly<Record<SolutionSlug, Readonly<Record<SupportedLocale, LocalizedSolution>>>> = {
  "telegram-commerce": {
    en: {
      seoTitle: "Telegram commerce: sell digital products in chat | Selinow",
      seoDescription: "Run a Telegram storefront with one shared catalog, a dedicated bot, verified PayOS payments, and automatic digital delivery inside the conversation.",
      eyebrow: "TELEGRAM COMMERCE",
      title: "Sell on Telegram, operate from one system.",
      lead: "Give customers a familiar buying path inside Telegram — a dedicated shop bot, product cards, verified payment, and automatic delivery — while your team runs products, orders, and fulfillment from one operating layer.",
    ...
    "vi-VN": {
      seoTitle: "Bán hàng qua Telegram — cửa hàng số tự động | Selinow",
      seoDescription: "Bán hàng qua Telegram với catalog dùng chung website, bot bán tự động, thanh toán PayOS xác minh và giao sản phẩm số ngay trong hội thoại.",
      eyebrow: "THƯƠNG MẠI TELEGRAM",
      title: "Bán hàng qua Telegram, vận hành trên một hệ thống.",
      lead: "Đưa khách vào luồng mua quen thuộc trong Telegram — bot cửa hàng riêng, product card, thanh toán xác minh và giao hàng tự động — trong khi đội ngũ vận hành sản phẩm, đơn hàng và fulfillment trên một lớp điều hành duy nhất.",
  ...
  "digital-product-delivery": {
    en: {
      seoTitle: "Automatic digital product delivery after checkout | Selinow",
      seoDescription: "Automate ebook, course, file, and license delivery after verified payment — clear order states, private grants, and safe retry boundaries.",
      eyebrow: "DIGITAL PRODUCT DELIVERY",
      title: "Automatic digital delivery with exact order states.",
      lead: "Keep checkout, payment verification, entitlement, and delivery as separate, visible states so a customer gets access only when the order is truly ready — no guesswork, no manual sending.",
      answerLabel: "The short answer",
    ...
    "vi-VN": {
      seoTitle: "Giao sản phẩm số tự động sau thanh toán | Selinow",
      seoDescription: "Tự động giao ebook, khóa học, file số và license sau khi thanh toán được xác minh — trạng thái đơn rõ ràng, private grant và retry an toàn.",
      eyebrow: "GIAO SẢN PHẨM SỐ",
      title: "Giao sản phẩm số tự động, chính xác từng trạng thái.",
      lead: "Giữ checkout, xác minh thanh toán, entitlement và giao hàng thành các trạng thái riêng, luôn nhìn thấy được — khách chỉ nhận quyền truy cập khi đơn hàng thực sự sẵn sàng, không gửi tay, không phỏng đoán.",
      answerLabel: "Câu trả lời ngắn",
  ...
  "license-key-inventory": {
    en: {
      seoTitle: "License key management & secure key inventory | Selinow",
      seoDescription: "Manage encrypted license-key inventory with one-winner allocation, duplicate-key guards, and automatic key delivery after verified payment.",
      eyebrow: "LICENSE KEY INVENTORY",
      title: "License key management that treats keys like real stock.",
      lead: "Protect key material, prevent cross-store allocation, and connect key availability to a verified order lifecycle your team can inspect.",
      answerLabel: "The short answer",
    ...
    "vi-VN": {
      seoTitle: "Quản lý license key & kho mã số an toàn | Selinow",
      seoDescription: "Quản lý kho license key mã hóa với cấp phát một người thắng, chống trùng key giữa các đơn và giao key tự động sau thanh toán xác minh.",
      eyebrow: "INVENTORY LICENSE KEY",
      title: "Quản lý license key như một kho hàng thật sự.",
      lead: "Bảo vệ key material, ngăn cấp phát chéo shop và gắn tồn kho key với vòng đời đơn hàng đã xác minh để đội ngũ luôn kiểm tra được.",
      answerLabel: "Câu trả lời ngắn",
