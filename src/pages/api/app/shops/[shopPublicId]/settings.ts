...
const ALLOWED = ["accentColor", "announcement", "deliveryText", "description", "expectedVersion", "footerText", "headline", "logoUrl", "primaryColor", "seoDescription", "seoTitle", "showExactStock", "supportText"];
