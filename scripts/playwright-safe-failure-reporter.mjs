...
export function redactPlaywrightFailure(value) {
  return String(value)
    ...
    .replace(/((?:SESSION_SECRET|MAGIC_LINK_SECRET|IDENTIFIER_HMAC_SECRET|CREDENTIAL_KEK_V1|INVENTORY_KEK_V1|EXPORT_KEK_V1|TURNSTILE_SECRET_KEY)\s*[:=]\s*)[^\s,;]+/gu, "$1[redacted]")
