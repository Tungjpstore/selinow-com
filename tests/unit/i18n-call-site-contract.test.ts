...
const DYNAMIC_TRANSLATION_ALLOWLIST: readonly DynamicAllowlistEntry[] = [
  {
    ...
    guard: /exceptionTypeLabel[\s\S]*identity_mismatch[\s\S]*\? value : "default"/u,
    identifier: "t",
    path: "src/pages/app/payments.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.usp.${safeVertical}.${index}.body`",
    guard: /const safeVertical = vertical === "physical" \|\| vertical === "booking" \? vertical : "digital";[\s\S]*`storefront\.section\.usp\.\$\{safeVertical\}\.\$\{index\}\.body`/u,
    identifier: "t",
    path: "src/components/storefront/sections/USPGrid.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.usp.${safeVertical}.${index}.title`",
    guard: /const safeVertical = vertical === "physical" \|\| vertical === "booking" \? vertical : "digital";[\s\S]*`storefront\.section\.usp\.\$\{safeVertical\}\.\$\{index\}\.title`/u,
    identifier: "t",
    path: "src/components/storefront/sections/USPGrid.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.faq.${safeVertical}.${index}.a`",
    guard: /const safeVertical = vertical === "physical" \|\| vertical === "booking" \? vertical : "digital";[\s\S]*`storefront\.section\.faq\.\$\{safeVertical\}\.\$\{index\}\.a`/u,
    identifier: "t",
    path: "src/components/storefront/sections/FAQSection.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.faq.${safeVertical}.${index}.q`",
    guard: /const safeVertical = vertical === "physical" \|\| vertical === "booking" \? vertical : "digital";[\s\S]*`storefront\.section\.faq\.\$\{safeVertical\}\.\$\{index\}\.q`/u,
    identifier: "t",
    path: "src/components/storefront/sections/FAQSection.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.usp.${builderVertical}.${index}.body`",
    guard: /const builderVertical = settings\?\.template\.vertical \?\? "digital";[\s\S]*`storefront\.section\.usp\.\$\{builderVertical\}\.\$\{index\}\.body`/u,
    identifier: "ts",
    path: "src/pages/app/store.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.usp.${builderVertical}.${index}.title`",
    guard: /const builderVertical = settings\?\.template\.vertical \?\? "digital";[\s\S]*`storefront\.section\.usp\.\$\{builderVertical\}\.\$\{index\}\.title`/u,
    identifier: "ts",
    path: "src/pages/app/store.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.faq.${builderVertical}.${index}.a`",
    guard: /const builderVertical = settings\?\.template\.vertical \?\? "digital";[\s\S]*`storefront\.section\.faq\.\$\{builderVertical\}\.\$\{index\}\.a`/u,
    identifier: "ts",
    path: "src/pages/app/store.astro",
  },
  {
    catalog: "storefront",
    expression: "`storefront.section.faq.${builderVertical}.${index}.q`",
    guard: /const builderVertical = settings\?\.template\.vertical \?\? "digital";[\s\S]*`storefront\.section\.faq\.\$\{builderVertical\}\.\$\{index\}\.q`/u,
    identifier: "ts",
    path: "src/pages/app/store.astro",
  },
  {
  ...
  {
    catalog: "marketing",
    expression: "`marketing.home.channels.name.${channel.key}`",
    guard: /const channels = \[[\s\S]*?"website"[\s\S]*?"api",[\s\S]*?\] as const;[\s\S]*`marketing\.home\.channels\.name\.\$\{channel\.key\}`/u,
    identifier: "t",
    path: "src/components/marketing/sections/HeroEditorial.astro",
  },
  {
    catalog: "marketing",
    expression: "`marketing.home.channels.status.${channel.state}`",
    guard: /const channels = \[[\s\S]*?"live"[\s\S]*?"planned"[\s\S]*\] as const;[\s\S]*`marketing\.home\.channels\.status\.\$\{channel\.state\}`/u,
    identifier: "t",
    path: "src/components/marketing/sections/HeroEditorial.astro",
  },
  {
    ...
    guard: /const channels = \[[\s\S]*?"website"[\s\S]*?"api",[\s\S]*\] as const;[\s\S]*`marketing\.home\.channels\.name\.\$\{channel\.key\}`/u,
    identifier: "t",
    path: "src/components/marketing/sections/CommerceCore.astro",
  },
  {
    catalog: "marketing",
    expression: "`marketing.home.channels.status.${channel.state}`",
  ...
  {
    catalog: "marketing",
    expression: "`marketing.home.why.${tile.key}.title`",
    guard: /const tiles = \[[\s\S]*?one_catalog[\s\S]*?visibility[\s\S]*\];[\s\S]*`marketing\.home\.why\.\$\{tile\.key\}\.title`/u,
    identifier: "t",
    path: "src/components/marketing/sections/WhyBento.astro",
  },
  {
    catalog: "marketing",
    expression: "`marketing.home.why.${tile.key}.description`",
    guard: /const tiles = \[[\s\S]*?one_catalog[\s\S]*?visibility[\s\S]*\];[\s\S]*`marketing\.home\.why\.\$\{tile\.key\}\.description`/u,
    identifier: "t",
    path: "src/components/marketing/sections/WhyBento.astro",
  },
  {
