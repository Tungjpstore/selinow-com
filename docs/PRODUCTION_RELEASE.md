...
- The current working tree contains uncommitted source/UI changes. A reviewed, pinned commit and a new release manifest are required before deploying or migrating the continuation.
