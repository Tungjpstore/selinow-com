...
The dashboard client must use the `API_ENDPOINT_INDEX.csv` as its only route inventory. The current source index contains 210 method/path rows. Important dashboard seams are:
